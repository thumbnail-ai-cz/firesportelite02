...
const vsechnyEpizody = [
    ...
    { id: "WcTlrSw4Nhc", title: "CO SE DĚLO 6.12.2025 V ČESKÉM RUDOLCI?", duration: "00:14:16", label: "#14", cat: "aftermovie" },
    { id: "TW-iHKnFRwM", title: "PŘÍBĚH 10ti NÁSOBNÉHO MISTRA ČR, Vít Vymazal 🔥", duration: "01:05:58", label: "#13", cat: "podcast" },
    { id: "nKHb3OIuKIs", title: "NA KAŽDOU SOUTĚŽ JEZDÍM VYHRÁT - Jakub Sirbu, SDH Pasohlávky B", duration: "01:11:56", label: "#12", cat: "podcast" },
    { id: "Y9FYu6omTQg", title: "NEJPOPULÁRNĚJŠÍ AKCE V POŽÁRNÍM ÚTOKU NA SVĚTĚ - FLÍDR CUP 2025 🏆", duration: "00:22:44", label: "#11", cat: "aftermovie" },
    { id: "ue4aHwL5BQ0", title: "Jaký je skutečný důvod neúčasti Zdendy Kalouse na letošním Mistrovství Evropy v PÚ? 😮", duration: "01:17:44", label: "#10", cat: "podcast" },
    ...
    { id: "8v81kiNYiGE", title: "Zvednout nad hlavu mistrovský pohár je neskutečný pocit, říká Sabča Jírovcová ", duration: "00:31:30", label: "#2", cat: "podcast" },
    { id: "nQapCig1suQ", title: "Prchalov je srdcovka! Odmítl jsem nabídky na přestup i za více než 100k…, říká Jakub Šenk", duration: "00:30:28", label: "#1", cat: "podcast" },
  ];
