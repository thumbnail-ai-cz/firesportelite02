    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-5xl mx-auto p-8 pt-28">
        ...
        <section id="epizody" className="text-center my-16">
          <h2 className="text-8xl font-extrabold mb-1 border-l-4 border-red-600 pl-4 inline-block">Připrav si něco dobrého k jídlu nebo pití a užij si nejnovější epizodu</h2>
